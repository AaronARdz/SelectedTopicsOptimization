...
from tspparse import read_tsp_file, minimal_tsp, scan_keywords, read_cities
from timeit import Timer

# problem = tsplib95.load('archives/att48.tsp')
path = 'archives/eil101.tsp'
...
tspfile = read_tsp_file(path)


# print(nearest_neighbor_tour(tspfile))
# print(calc_nearest_neighbor_tour(tspfile))

def mainAlgo():
    start_time = Timer()
    print(calc_nearest_neighbor_tour(tspfile))
    print(start_time.timeit())
